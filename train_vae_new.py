...
from src.vae.vae_runner import HypVaeDataset, Trainer, HypVaeDatasetNew
...
try:
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % 20 == 0:
            print("epoch: ", epoch)
            trainer.evaluate_new(valid_loader, dataset.train_mat, dataset.valid_dict,
                                 variational=True, show_progress=args.show_progress)
