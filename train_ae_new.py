...
from src.batchrunner import train, evaluate, report_metrics, evaluate_new
from src.datareader import read_data, read_data_new
...
parser.add_argument("--datapack", type=str, choices=["persdiff", "urm"])
...
for epoch in range(args.epochs):
    ...
    if (epoch + 1) % 20 == 0:
        print('epoch: ', epoch)
        evaluate_new(infer_loader, train_mat_val, test_items, model, show_progress=show_progress)
